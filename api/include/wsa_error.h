...
#define WSA_ERR_WSADEVPTRNULL	(LNEG_NUM - 107)
...
#define WSA_ERR_INV_SWEEP_FREQ1 (LNEG_NUM - 3016)
#define WSA_ERR_INV_SWEEP_FREQ2 (LNEG_NUM - 3017)
#define WSA_ERR_INV_SWEEP_FREQ3 (LNEG_NUM - 3018)
#define WSA_ERR_INV_SWEEP_FREQ4 (LNEG_NUM - 3019)
