...
static struct wsa_err_item {
	...
	// File related
	//*****
	wsa_err_item(WSA_ERR_FILECREATEFAILED, "Unable to create the file"),
	wsa_err_item(WSA_ERR_FILEOPENFAILED, "Unable to open the file"),
	wsa_err_item(WSA_ERR_FILEREADFAILED, "Unable to read the file"),
	wsa_err_item(WSA_ERR_FILEWRITEFAILED, "Unable to write to the file"),
	...
	wsa_err_item(WSA_ERR_INVREGADDR, "Invalid register address"),
	wsa_err_item(WSA_ERR_MALLOCFAILED, "Memory allocation failed"),
	wsa_err_item(WSA_ERR_UNKNOWN_ERROR, "Unknow error")
