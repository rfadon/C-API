...
CLI_SOURCE_DIR = test/src
CLI_BUILD_DIR = $(BUILD_DIRECTORY)/test
...
CLI_INCLUDE_FLAGS = $(API_INCLUDE_FLAGS) -Itest/include -Icli/include/include-$(BUILD_PLATFORM)
BUILD_BINARY_DIRECTORY = $(BUILD_DIRECTORY)/bin
ifeq ($(BUILD_PLATFORM), windows)
CLI_TARGET = $(BUILD_BINARY_DIRECTORY)/reg_tester.exe
else
